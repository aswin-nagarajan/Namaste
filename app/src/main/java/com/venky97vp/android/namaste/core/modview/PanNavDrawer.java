...
public class PanNavDrawer extends NavigationView {
    public PanNavDrawer(Context context) {
        super(context);
        setFont();
    }

    public PanNavDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
        setFont();
    }

    public PanNavDrawer(Context context, AttributeSet attrs, int defStyleAttr) {

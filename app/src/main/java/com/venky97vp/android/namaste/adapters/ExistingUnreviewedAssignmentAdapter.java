...
public class ExistingUnreviewedAssignmentAdapter extends RecyclerView.Adapter<AssignmentViewHolder>{
    Context ctx;
    List<Assignment> list;

    public ExistingUnreviewedAssignmentAdapter(Context ctx, List<Assignment> list){
        this.ctx= ctx;
        this.list = list;
    }
    @Override
